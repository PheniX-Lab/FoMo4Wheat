...
from dinov2.run.submit import get_args_parser, submit_load_cp_jobs
...
class Trainer(object):
    ...
    def __call__(self):
        from dinov2.train import main_load_cp as train_main
...
def main():
    ...
    submit_load_cp_jobs(Trainer, args, name="dinov2:train")
    return 0
